...
export const metadata: Metadata = {
  ...
  title: "دانشنامه تخصصی انرژی خورشیدی و تاسیسات",
  description:
    "دانشنامه تخصصی پارسا انرژی با ۲۶+ مقاله کاربردی در حوزه نیروگاه خورشیدی، تاسیسات مکانیکی، برق اضطراری، پمپ حرارتی و قوانین انرژی. مطالعه راهنمای کامل.",
  keywords: [
