...
export const metadata: Metadata = {
  ...
  title: "مرجع جامع سیستم‌های برق، برق خورشیدی و برق اضطراری | پارسا انرژی",
  description:
    "راهنمای جامع مهندسی برق، طراحی و اجرای سیستم‌های برق خورشیدی، تامین برق اضطراری (UPS و دیزل ژنراتور)، سایزینگ کابل و افت ولتاژ، و تعمیرات تخصصی اینورتر در مشهد.",
  keywords: [
    "برق",
    "برق خورشیدی",
    "برق اضطراری",
...
const faqs = [
  {
    q: "برق خورشیدی (سولار) چگونه کار می‌کند و چه مزایایی نسبت به برق شهری دارد؟",
    a: "سیستم برق خورشیدی با جذب تابش نور خورشید توسط پنل‌ها، جریان مستقیم (DC) تولید می‌کند. این جریان از طریق اینورتر به جریان متناوب (AC) تبدیل شده و برای مصرف خانگی یا صنعتی آماده می‌شود. مهم‌ترین مزایای آن عدم وابستگی به قطعی برق شبکه‌ای، کاهش هزینه‌های انرژی و طول عمر بالای ۲۵ سال است.",
  },
  {
    q: "بهترین راهکار برای مقابله با قطعی برق چیست؟ تفاوت بین UPS و دیزل ژنراتور چیست؟",
    a: "برای تجهیزات حساس الکترونیکی (کامپیوترها، بردهای کنترل، سرورها و پکیج‌های گرمایشی) سیستم UPS بدون حتی یک میلی‌ثانیه قطعی جریان برق را تامین می‌کند. اما دیزل ژنراتور برای مصارف سنگین صنعتی با زمان پشتیبانی طولانی مناسب است. ترکیب UPS و ژنراتور ایده‌آل‌ترین سیستم برق اضطراری را شکل می‌دهد.",
  },
  {
  ...
  {
    q: "آیا اینورترها و بردهای الکترونیکی برق خورشیدی قابل تعمیر هستند؟",
    a: "بله، مرکز تخصصی پارسا انرژی در مشهد خدمات تشخیص عیب در سطح قطعه (Component-Level Repair)، عیب‌یابی با اسیلوسکوپ، تعویض IGBTها، خازن‌های قدرت و بردهای کنترل اینورترهای SMA، Victron، Deye، Growatt و Sofar را ارائه می‌دهد.",
  },
  {
    q: "هزینه راه اندازی سیستم برق خورشیدی یا برق اضطراری چگونه محاسبه می‌شود؟",
    a: "هزینه نهایی بستگی به مجموع توان درخواستی (بر حسب کیلووات یا کیلوولت‌آمپر)، ساعات پشتیبانی مورد نیاز در قطعی برق، نوع باتری (LiFePO4 یا ژل) و جنس قطعات حفاظتی دارد. می‌توانید از ابزارهای آنلاین محاسبه‌گر پارسا انرژی استفاده کنید.",
  },
  {
