...
export const kbArticles: KB_article[] = [
  /* ============ HVAC ============ */
  {
    ...
    excerpt: {
      fa: "راهنمای جامع انتخاب هوشمندانه سیستم گرمایشی و سرمایشی مسکونی و تجاری، مقایسه دقیق بازدهی پکیج و رادیاتور در برابر کولر گازی و داکت اسپلیت اینورتر با تحلیل کاهش ۳۰ درصدی مصرف انرژی برق و گاز در اقلیم خراسان.",
  ...
  },
  {
    ...
    categoryLabel: { fa: "تاسیسات", en: "HVAC" },
    excerpt: {
      fa: "بررسی میدانی مزایا و معایب رادیاتور شوفاژ از نگاه تکنسین‌های اجرایی، بررسی طول عمر ۲۰ تا ۳۰ ساله و گرمای مطبوع یکنواخت در کنار الزامات لوله‌کشی و زمان راه‌اندازی اولیه در فصول سرد سال.",
  ...
  },
  {
    ...
    categoryLabel: { fa: "تاسیسات", en: "HVAC" },
    excerpt: {
      fa: "تحلیل تخصصی مزایا و چالش‌های کولر گازی اسپلیت، سرعت خنک‌کنندگی در ۵ دقیقه، نقش فناوری اینورتر در کاهش ۳۰ درصدی هزینه برق و الزامات سرویس و شارژ دوره‌ای مبرد در شرایط اقلیمی مشهد.",
  ...
  },
  {
    ...
    categoryLabel: { fa: "تاسیسات", en: "HVAC" },
    excerpt: {
      fa: "ارزیابی فنی کارایی سیستم زنت در ساختمان، بررسی گرمایش سریع موضعی در ۱ تا ۲ دقیقه بدون نیاز به لوله‌کشی در مقابل میزان مصرف برق و تاثیر آن بر رطوبت محیط کارگاهی و مسکونی.",
  ...
  },
  {
    ...
    categoryLabel: { fa: "تاسیسات", en: "HVAC" },
    excerpt: {
      fa: "آشنایی با مکانیزم عملکرد سیستم زنت و نحوه تولید گرمایش سریع با المنت‌های ۱۵۰۰ تا ۳۰۰۰ وات الکتریکی، بررسی تفاوت‌های عملکردی با شوفاژ خانگی و راهنمای انتخاب برای فضاها.",
  ...
  },
  {
    ...
    categoryLabel: { fa: "تاسیسات", en: "HVAC" },
    excerpt: {
      fa: "بررسی مهندسی سیستم داکت اسپلیت برای ساختمان‌ها و فضاهای بالای ۱۵۰ متر، پنهان‌سازی تجهیزات در سقف کاذب، توزیع متوازن بار برودتی و مقایسه هزینه راه‌اندازی و نگهداری با کولر گازی مجزا.",
  ...
  /* ============ Solar ============ */
  {
    ...
    body: {
      fa: [
        ...
        { h2: "ترکیب بهینه", p: "برای یک منزل: UPS ۳ کیلوولت‌آمپر + خورشیدی هایبرید ۵ کیلووات. برای کارخانه: دیزل ژنراتور ۱۰۰ کیلووات + خورشیدی ۵۰ کیلووات. برای بیمارستان: UPS + دیزل + خورشیدی + ATS. جهت مشاوره و [طراحی و نصب سیستم برق اضطراری](/services/emergency-power-design-install) مهندسان پارسا انرژی در مشهد آماده پاسخگویی هستند." },
      ],
      en: [
    ...
    faqs: [
      { q: { fa: "UPS بهتر است یا دیزل ژنراتور؟", en: "UPS or diesel generator?" }, a: { fa: "سیستم UPS برای بارهای بدون وقفه و حساس (تجهیزات پزشکی، سرور و اتاق کنترل) حیاتی است؛ در حالی که دیزل ژنراتور توان پشتیبانی طولانی‌مدت را دارد و ترکیب این دو بالاترین ضریب اطمینان را فراهم می‌سازد.", en: "UPS for short critical loads (servers, medical) with no interruption; diesel for long power. Combining both is best." } },
    ],
  },
  {
  ...
  },
  {
    ...
    body: {
      fa: [
        ...
        { h2: "تصمیم: تضمینی یا بورس؟", p: "برای سرمایه‌گذاران با نیروگاه بزرگ، بورس درآمد بالاتری دارد اما برای سرمایه‌گذاری مطمئن با ارزیابی دقیق بازگشت سرمایه، بررسی [توجیه اقتصادی احداث نیروگاه ۱۴۰۵](/knowledge/solar-economic-justification-1405) پیشنهاد می‌شود. جهت دریافت پکیج تحلیلی و امکان‌سنجی، کارشناسان پارسا انرژی مشاوره تخصصی ارائه می‌دهند." },
      ],
      en: [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: { fa: "بله، یک پمپ حرارتی Air-to-Water می‌تواند گرمایش، آب گرم مصرفی و با افزودن فن‌کویل سرمایش محیط را به طور کامل پوشش دهد؛ از همین رو نیاز به خرید و نگهداری مجزای پکیج و اسپلیت برطرف می‌شود.", en: "Yes, an Air-to-Water heat pump can provide heating, domestic hot water, and — with a fan coil — cooling. Both the package boiler and split AC can be eliminated." }
      }
    ]
  },
  {
    ...
    categoryLabel: { fa: "خورشیدی", en: "Solar" },
    excerpt: {
      fa: "بررسی ذخیره‌سازهای انرژی خانگی و صنعتی LiFePO4 با طول عمر ۴۰۰۰ تا ۶۰۰۰ سیکل کاری، راهکاری مطمئن برای تامین ۴ تا ۸ ساعت برق مداوم در زمان خاموشی‌های برنامه‌ریزی‌شده شبکه سراسری.",
    ...
    body: {
      fa: [
        ...
        },
        {
          ...
          p: "اگر به ذخیره‌ساز فکر می‌کنید، اولین گام محاسبه بار حساس خانه است: کدام دستگاه‌ها در زمان قطعی حتماً باید روشن بمانند؟ مصرف هر کدام را در وات ضرب در ساعت مصرف روزانه کنید تا ظرفیت مورد نیاز باتری مشخص شود. سپس با کارشناس پارسا انرژی مشورت کنید تا مدل مناسب در فرآیند [طراحی و نصب سیستم برق اضطراری](/services/emergency-power-design-install) انتخاب شود. مشاوره اولیه ۳۰ دقیقه‌ای رایگان است و شامل برآورد هزینه، انتخاب مدل و طراحی سیستم می‌شود."
        }
      ],
      en: [
        {
  ...
  },
  {
    ...
    categoryLabel: { fa: "تاسیسات", en: "HVAC" },
    excerpt: {
      fa: "بررسی مزایای فنی و اقتصادی چیلرهای جذبی گازی در پروژه‌های ساختمانی بزرگ، کاهش ۹۰ تا ۹۵ درصدی مصرف برق نسبت به چیلرهای تراکمی، طول عمر بالای ۲۰ سال و بازگشت سرمایه در بازه ۱۸ تا ۳۰ ماه.",
  ...
  },
  {
    ...
    categoryLabel: { fa: "تاسیسات", en: "HVAC" },
    excerpt: {
      fa: "راهنمای عایق‌بندی حرارتی اصولی سقف، نما و پنجره‌های دوجداره ساختمان‌ها جهت جلوگیری از هدررفت ۴۰ درصدی انرژی گرمایشی و سرمایشی با بازگشت سرمایه زیر ۲ سال در اقلیم خراسان.",
    ...
    body: {
      fa: [
        ...
        },
        {
          ...
          p: "اگر به این سرمایه‌گذاری فکر می‌کنید، مسیر به این شکل است. اول، ارزیابی اولیه: بررسی تابش منطقه، متراژ بام یا زمین در دسترس، و محاسبه ظرفیت ممکن. دوم، مشاوره تخصصی و دریافت پیش‌فاکتور برای [طراحی و احداث نیروگاه خورشیدی](/services/solar-plant-design-construction). سوم، اخذ مجوز احداث از ساتبا. چهارم، نصب و راه‌اندازی نیروگاه. پنجم، اتصال به شبکه و عقد قرارداد ۲۰ ساله خرید تضمینی. پارسا انرژی تمام این مراحل را از صفر تا صد همراه شما اجرا می‌کند."
        }
      ],
      en: [
        {
...
// ============================================================================
{
  ...
  faqs: [
    ...
    },
    {
      ...
      a: { fa: "در شب، ماینر از برق شبکه استفاده می‌کند. اما در روز، نیروگاه خورشیدی برق مازاد را به شبکه می‌فروشد؛ از این رو هزینه مصرف شبانه با ارزش تولید روزانه پایاپای شده و تراز صورتحساب صفر می‌گردد.", en: "At night, the miner uses grid power. But during the day, the solar plant sells surplus to the grid. Net grid consumption is zero, and the final bill is zero." }
    }
  ]
},
...
// ============================================================================
{
  ...
  categoryLabel: { fa: "تاسیسات", en: "HVAC" },
  excerpt: {
    fa: "راهنمای نصب و به‌کارگیری اینورترهای صنعتی VFD روی پمپ‌ها، فن‌ها و کمپرسورهای کارخانجات جهت کاهش ۳۰ تا ۵۰ درصدی بهای برق مصرفی با بازگشت سرمایه زیر یک سال.",
  ...
  body: {
    fa: [
      ...
      },
      {
        ...
        p: "اگر به درستی نگهداری شود، یک VFD صنعتی ۱۰ تا ۱۵ سال کار می‌کند. نگهداری شامل: تمیز کردن فیلترهای هوا هر ۳ تا ۶ ماه، بررسی ترمینال‌ها، تست خازن‌های DC و پایش دمای فن‌هاست. در صورت بروز خرابی یا ارور درایو، خدمات [تعمیر تخصصی برد الکترونیکی مشهد](/services/electronic-board-repair-spec) و عیب‌یابی در سطح قطعه توسط آزمایشگاه پارسا انرژی با ضمانت کتبی ارائه می‌شود."
      },
      {
...
// ============================================================================
{
  ...
  categoryLabel: { fa: "اخبار و قوانین", en: "News" },
  excerpt: {
    fa: "راهنمای جامع دریافت تسهیلات بانکی احداث نیروگاه خورشیدی از بانک صنعت و معدن و صندوق نوآوری و شکوفایی با نرخ سود ترجیحی و دوره تنفس ۲ ساله برای سرمایه‌گذاران.",
  ...
  body: {
    fa: [
      ...
      },
      {
        ...
        p: "چهار منبع اصلی تسهیلات خورشیدی در ایران وجود دارد. اول، بانک صنعت و معدن که برای نیروگاه‌های بالای ۱۰۰ کیلووات تسهیلات ارزی و ریالی ارائه می‌دهد؛ نرخ بهره ۹ تا ۱۲ درصد، مدت بازپرداخت ۷ تا ۱۰ سال، با دوره تنفس ۲ ساله. دوم، صندوق نوآوری و شکوفایی که برای پروژه‌های پیشرفته و دانش‌بنیان نیروگاهی تسهیلات تا ۵۰ میلیارد تومان با نرخ بهره ۵ تا ۸ درصد ارائه می‌دهد. سوم، بانک مهر اقتصاد که برای نیروگاه‌های خانگی و کوچک تا ۱۰ کیلووات تسهیلات ارائه می‌دهد. چهارم، صندوق پژوهش و فناوری که برای پروژه‌های دانش‌بنیان مرتبط با خورشیدی تسهیلات می‌دهد. در سال‌های اخیر، بانک‌های تجاری نیز با همکاری ساتبا خطوط اعتباری تخصصی ارائه داده‌اند."
      },
      {
...
// ============================================================================
{
  ...
  categoryLabel: { fa: "اخبار و قوانین", en: "News" },
  excerpt: {
    fa: "آشنایی با سیستم مدیریت انرژی هوشمند (EMS) مبتنی بر اینترنت اشیا، پایش لحظه‌ای پارامترهای مصرف برق، گاز و آب و شناسایی نقاط اتلاف انرژی با بازگشت سرمایه ۶ تا ۱۲ ماهه در صنایع.",
